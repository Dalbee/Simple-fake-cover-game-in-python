...
print(parser.title.replace('- Wikipedia', '')) #removes - Wikipedia.
...
band_title = parser.title.replace('- Wikipedia', '') # assigns parser.title to band_title
print(band_title)
...
parser.feed(html_string)
print(parser.title.replace('- Wikipedia', '')) #removes - Wikipedia.
album_title = parser.title.replace('- Wikipedia', '') # assigns parser.title to band_title
